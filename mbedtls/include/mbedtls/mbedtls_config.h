...
// be enabled */ #define MBEDTLS_PLATFORM_TIME_TYPE_MACRO time_t
///**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */ #define
// MBEDTLS_PLATFORM_FPRINTF_MACRO      fprintf /**< Default fprintf macro to use, can be undefined */ #define
...
/* RSA OPTIONS */
//#define MBEDTLS_RSA_GEN_KEY_MIN_BITS            1024 /**<  Minimum RSA key size that can be generated in bits (Minimum
// possible value is 128 bits) */
